...
public class Mail implements TalendJob {
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String from_tSendMail_1 = ("inessadki1254@gmail.com");
				String to_tSendMail_1 = ("ines.sadki1@outlook.com").replace(";", ",");
				String cc_tSendMail_1 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String bcc_tSendMail_1 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String subject_tSendMail_1 = ("Test des emails avec Talend");
				...
				String message_tSendMail_1 = (("Hello talend") == null || "".equals("Hello talend")) ? "\"\""
						: ("Hello talend");
				...
				try {
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:aR+ELVwxDfb0WDGadA3CmdrqR/Esk6NRUAHv40xWJRtNSBf97w==");
					...
					msg_tSendMail_1.setFrom(new javax.mail.internet.InternetAddress(from_tSendMail_1, "Talend"));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mail.class.getClassLoader()
					.getResourceAsStream("test_etl/mail_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Mail.class.getClassLoader()
...
/************************************************************************************************
 * 31105 characters generated by Talend Open Studio for Data Integration on the
 * 27 septembre 2023 à 18:24:31 GMT+01:00
 ************************************************************************************************/