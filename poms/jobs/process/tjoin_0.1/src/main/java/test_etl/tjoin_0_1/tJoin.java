...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TEST_ETL_tJoin = new byte[0];
    static byte[] commonByteArray_TEST_ETL_tJoin = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_ETL_tJoin.length) {
				if(length < 1024 && commonByteArray_TEST_ETL_tJoin.length == 0) {
   					commonByteArray_TEST_ETL_tJoin = new byte[1024];
				} else {
   					commonByteArray_TEST_ETL_tJoin = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_ETL_tJoin, 0, length);
			strReturn = new String(commonByteArray_TEST_ETL_tJoin, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_ETL_tJoin) {
...
row3Struct row3 = new row3Struct();
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"age","sex","bmi","children","smoker","region","charges","id","Year","Make","Model","Kilometres","Body_Type","Engine","_Transmission","Drivetrain","_Exterior_Colour","_Interior_Colour","_Passengers","Doors","_Fuel_Type","City","_Highway","price","id_id",});        
	...
	currentComponent="tJoin_1";
			...
			row3 = null;	
				...
				row3 = new row3Struct();						
						...
						row3.sex = row1.sex;					
						row3.bmi = row1.bmi;					
						row3.children = row1.children;					
						row3.smoker = row1.smoker;					
						row3.region = row1.region;					
						row3.charges = row1.charges;					
						row3.id = row1.id;

			if(util_tJoin_1.isJoined(row1)){ 			
								row3.Year = util_tJoin_1.lookupValue.Year;			
								row3.Make = util_tJoin_1.lookupValue.Make;			
								row3.Model = util_tJoin_1.lookupValue.Model;			
								row3.Kilometres = util_tJoin_1.lookupValue.Kilometres;			
								row3.price = util_tJoin_1.lookupValue.price;			
								row3.id_id = util_tJoin_1.lookupValue.id;
			} 
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:8bsAh1kQU6TXrIMYtpLasivvyVFrtnWAAAdZFEERao5FHECm/fqiuw==");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = tJoin.class.getClassLoader().getResourceAsStream("test_etl/tjoin_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = tJoin.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     115417 characters generated by Talend Open Studio for Data Integration 
