...
package test_etl.generer_calendrier2_0_2;
		...
		public void synchronizeContext(){
			...
			if(date_deb != null){
					...
					if(parts_date_deb.length > 1){
						...
						this.setProperty("date_deb", pattern_date_deb + ";" + FormatterUtils.format_Date(date_deb, pattern_date_deb));
					}else{
...
row2Struct row2 = new row2Struct();
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"Calendrier_Simplifier","Annees","Trimestres","nb_Mois","Mois","Jours",});        
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QE1P9dUm/kYbdk2ncqNdy/ndx+m+qx6niOldGed8/KlJYc1pJBBqYw==");
...
int count_tDBOutput_2=0;
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"Calendrier_Simplifier\",\"Annees\",\"Trimestres\",\"nb_Mois\",\"Mois\",\"Jours\") VALUES (?,?,?,?,?,?)";
...
out2_tmp.Trimestres = TalendDate.getPartOfDate("MONTH", out1.Calendrier_Simplifier)<3 ? "trimestre 1" :
TalendDate.getPartOfDate("MONTH", out1.Calendrier_Simplifier)<6 ? "trimestre 2" :
TalendDate.getPartOfDate("MONTH", out1.Calendrier_Simplifier)<9 ? "trimestre 3" :"trimerstre 4" ;
out2_tmp.nb_Mois = TalendDate.getPartOfDate("MONTH", out1.Calendrier_Simplifier)+1 ;
out2_tmp.Mois = TalendDate.formatDate("MMMM", out1.Calendrier_Simplifier).substring(0,1).toUpperCase()
+TalendDate.formatDate("MMMM", out1.Calendrier_Simplifier).substring(1)

/*TalendDate.formatDate("MMMM", out1.Calendrier_Simplifier).substring(1,TalendDate.formatDate("MMMM", out1.Calendrier_Simplifier).length()) */ ;
out2_tmp.Jours = TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==2?"Lindi":
TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==3?"Mardi":
TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==4?"Mercredi":
TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==5?"Jeudi":
TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==6?"Vendredi":
TalendDate.getPartOfDate("DAY_OF_WEEK", out1.Calendrier_Simplifier)==7?"Samedi":"Dimanche" 
...
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(out2.Calendrier_Simplifier.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setInt(2, out2.Annees);
}

                    if(out2.Trimestres == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, out2.Trimestres);
}

                    if(out2.nb_Mois == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(4, out2.nb_Mois);
}

                    if(out2.Mois == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, out2.Mois);
}

                    if(out2.Jours == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, out2.Jours);
}
...
///////////////////////		
	    		...
	    		if(row2.Calendrier_Simplifier != null) { //              
                 row_tLogRow_1[0]=    						
								FormatterUtils.format_Date(row2.Calendrier_Simplifier, "dd-MM-yy")
					          ;	
	    		...
	    		if(row2.Trimestres != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row2.Trimestres)			
					          ;	
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:jwOJz6Tz2pfh/BWMep1VnoiT6vSpIDslbiZOfCRH2msD6yh2WNxobw==");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Generer_calendrier2.class.getClassLoader().getResourceAsStream("test_etl/generer_calendrier2_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Generer_calendrier2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        try{
                            ...
                            context.date_deb=(java.util.Date)(new java.text.SimpleDateFormat(context_date_deb_pattern).parse(context_date_deb_value));

                        } catch(ParseException e) {
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "date_deb", e.getMessage()));
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("date_deb")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Generer_calendrier2");
        }
...
/************************************************************************************************
 *     100500 characters generated by Talend Open Studio for Data Integration 
