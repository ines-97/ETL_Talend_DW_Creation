...
public class tMap implements TalendJob {
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_TEST_ETL_tMap = new byte[0];
		static byte[] commonByteArray_TEST_ETL_tMap = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_ETL_tMap.length) {
					if (length < 1024 && commonByteArray_TEST_ETL_tMap.length == 0) {
						commonByteArray_TEST_ETL_tMap = new byte[1024];
					} else {
						commonByteArray_TEST_ETL_tMap = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_ETL_tMap, 0, length);
				strReturn = new String(commonByteArray_TEST_ETL_tMap, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_ETL_tMap) {
	...
	public static class Les_donnees_a_regeteesStruct
			implements routines.system.IPersistableRow<Les_donnees_a_regeteesStruct> {
		final static byte[] commonByteArrayLock_TEST_ETL_tMap = new byte[0];
		static byte[] commonByteArray_TEST_ETL_tMap = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(Les_donnees_a_regeteesStruct other) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Les_donnees_a_regeteesStruct Les_donnees_a_regetees = new Les_donnees_a_regeteesStruct();
				...
				util_tLogRow_1.addRow(new String[] { "id_id", "id", "age", "sex", "bmi", "children", "smoker", "region",
						"charges", "id_1", "id_id_1", "Year", "Make", "Model", "Kilometres", "Body_Type", "Engine",
						"_Transmission", "Drivetrain", "_Exterior_Colour", "_Interior_Colour", "_Passengers", "Doors",
						"_Fuel_Type", "City", "_Highway", "price", "generator", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Les_donnees_a_regetees");
				}
				...
				util_tLogRow_2.addRow(new String[] { "id_id", "id", "age", "sex", "bmi", "children", "smoker", "region",
						"charges", "id_1", "id_id_1", "Year", "Make", "Model", "Kilometres", "Body_Type", "Engine",
						"_Transmission", "Drivetrain", "_Exterior_Colour", "_Interior_Colour", "_Passengers", "Doors",
						"_Fuel_Type", "City", "_Highway", "price", "generator", });
...
// # Outputs initialization
				...
				Les_donnees_a_regeteesStruct Les_donnees_a_regetees_tmp = new Les_donnees_a_regeteesStruct();
// ###############################
...
// # Output reject table : 'Les_donnees_a_regetees'
// # Filter conditions 
							if (rejected_tMap_1) {
								Les_donnees_a_regetees_tmp.id_id = row1.id_id;
								Les_donnees_a_regetees_tmp.id = row2.id;
								Les_donnees_a_regetees_tmp.age = row1.age;
								Les_donnees_a_regetees_tmp.sex = row1.sex;
								Les_donnees_a_regetees_tmp.bmi = row1.bmi;
								Les_donnees_a_regetees_tmp.children = row1.children;
								Les_donnees_a_regetees_tmp.smoker = row1.smoker;
								Les_donnees_a_regetees_tmp.region = row1.region;
								Les_donnees_a_regetees_tmp.charges = row1.charges;
								Les_donnees_a_regetees_tmp.id_1 = row1.id;
								Les_donnees_a_regetees_tmp.id_id_1 = row1.id_id;
								Les_donnees_a_regetees_tmp.Year = row2.Year;
								Les_donnees_a_regetees_tmp.Make = row2.Make;
								Les_donnees_a_regetees_tmp.Model = row2.Model;
								Les_donnees_a_regetees_tmp.Kilometres = row2.Kilometres;
								Les_donnees_a_regetees_tmp.Body_Type = row2.Body_Type;
								Les_donnees_a_regetees_tmp.Engine = row2.Engine;
								Les_donnees_a_regetees_tmp._Transmission = row2._Transmission;
								Les_donnees_a_regetees_tmp.Drivetrain = row2.Drivetrain;
								Les_donnees_a_regetees_tmp._Exterior_Colour = row2._Exterior_Colour;
								Les_donnees_a_regetees_tmp._Interior_Colour = row2._Interior_Colour;
								Les_donnees_a_regetees_tmp._Passengers = row2._Passengers;
								Les_donnees_a_regetees_tmp.Doors = row2.Doors;
								Les_donnees_a_regetees_tmp._Fuel_Type = row2._Fuel_Type;
								Les_donnees_a_regetees_tmp.City = row2.City;
								Les_donnees_a_regetees_tmp._Highway = row2._Highway;
								Les_donnees_a_regetees_tmp.price = row2.price;
								Les_donnees_a_regetees_tmp.generator = Var.var1;
								Les_donnees_a_regetees = Les_donnees_a_regetees_tmp;
							} // closing filter/reject
// ###############################
...
///////////////////////		
							...
							row_tLogRow_1[0] = FormatterUtils.formatUnwithE(out1.id_id);

							row_tLogRow_1[1] = FormatterUtils.formatUnwithE(out1.id);

							if (out1.age != null) { //
								row_tLogRow_1[2] = FormatterUtils.formatUnwithE(out1.age);

							} //

							if (out1.sex != null) { //
								row_tLogRow_1[3] = String.valueOf(out1.sex);

							} //

							if (out1.bmi != null) { //
								row_tLogRow_1[4] = FormatterUtils.formatUnwithE(out1.bmi);

							} //

							if (out1.children != null) { //
								row_tLogRow_1[5] = FormatterUtils.formatUnwithE(out1.children);

							} //

							if (out1.smoker != null) { //
								row_tLogRow_1[6] = String.valueOf(out1.smoker);

							} //

							if (out1.region != null) { //
								row_tLogRow_1[7] = String.valueOf(out1.region);

							} //

							if (out1.charges != null) { //
								row_tLogRow_1[8] = FormatterUtils.formatUnwithE(out1.charges);

							} //

							if (out1.id_1 != null) { //
								row_tLogRow_1[9] = String.valueOf(out1.id_1);

							} //

							row_tLogRow_1[10] = FormatterUtils.formatUnwithE(out1.id_id_1);

							if (out1.Year != null) { //
								row_tLogRow_1[11] = FormatterUtils.formatUnwithE(out1.Year);

							} //

							if (out1.Make != null) { //
								row_tLogRow_1[12] = String.valueOf(out1.Make);

							} //

							if (out1.Model != null) { //
								row_tLogRow_1[13] = String.valueOf(out1.Model);

							} //

							if (out1.Kilometres != null) { //
								row_tLogRow_1[14] = String.valueOf(out1.Kilometres);

							} //

							if (out1.Body_Type != null) { //
								row_tLogRow_1[15] = String.valueOf(out1.Body_Type);

							} //

							if (out1.Engine != null) { //
								row_tLogRow_1[16] = String.valueOf(out1.Engine);

							} //

							if (out1._Transmission != null) { //
								row_tLogRow_1[17] = String.valueOf(out1._Transmission);

							} //

							if (out1.Drivetrain != null) { //
								row_tLogRow_1[18] = String.valueOf(out1.Drivetrain);

							} //

							if (out1._Exterior_Colour != null) { //
								row_tLogRow_1[19] = String.valueOf(out1._Exterior_Colour);

							} //

							if (out1._Interior_Colour != null) { //
								row_tLogRow_1[20] = String.valueOf(out1._Interior_Colour);

							} //

							if (out1._Passengers != null) { //
								row_tLogRow_1[21] = FormatterUtils.formatUnwithE(out1._Passengers);

							} //

							if (out1.Doors != null) { //
								row_tLogRow_1[22] = String.valueOf(out1.Doors);

							} //

							if (out1._Fuel_Type != null) { //
								row_tLogRow_1[23] = String.valueOf(out1._Fuel_Type);

							} //

							if (out1.City != null) { //
								row_tLogRow_1[24] = String.valueOf(out1.City);

							} //

							if (out1._Highway != null) { //
								row_tLogRow_1[25] = String.valueOf(out1._Highway);

							} //

							if (out1.price != null) { //
								row_tLogRow_1[26] = FormatterUtils.formatUnwithE(out1.price);

							} //

							if (out1.generator != null) { //
								row_tLogRow_1[27] = FormatterUtils.format_Date(out1.generator, "dd-MM-yyyy");
...
// Start of branch "Les_donnees_a_regetees"
						if (Les_donnees_a_regetees != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "Les_donnees_a_regetees");
							}

///////////////////////		

							String[] row_tLogRow_2 = new String[28];

							row_tLogRow_2[0] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.id_id);

							row_tLogRow_2[1] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.id);

							if (Les_donnees_a_regetees.age != null) { //
								row_tLogRow_2[2] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.age);

							} //

							if (Les_donnees_a_regetees.sex != null) { //
								row_tLogRow_2[3] = String.valueOf(Les_donnees_a_regetees.sex);

							} //

							if (Les_donnees_a_regetees.bmi != null) { //
								row_tLogRow_2[4] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.bmi);

							} //

							if (Les_donnees_a_regetees.children != null) { //
								row_tLogRow_2[5] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.children);

							} //

							if (Les_donnees_a_regetees.smoker != null) { //
								row_tLogRow_2[6] = String.valueOf(Les_donnees_a_regetees.smoker);

							} //

							if (Les_donnees_a_regetees.region != null) { //
								row_tLogRow_2[7] = String.valueOf(Les_donnees_a_regetees.region);

							} //

							if (Les_donnees_a_regetees.charges != null) { //
								row_tLogRow_2[8] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.charges);

							} //

							if (Les_donnees_a_regetees.id_1 != null) { //
								row_tLogRow_2[9] = String.valueOf(Les_donnees_a_regetees.id_1);

							} //

							row_tLogRow_2[10] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.id_id_1);

							if (Les_donnees_a_regetees.Year != null) { //
								row_tLogRow_2[11] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.Year);

							} //

							if (Les_donnees_a_regetees.Make != null) { //
								row_tLogRow_2[12] = String.valueOf(Les_donnees_a_regetees.Make);

							} //

							if (Les_donnees_a_regetees.Model != null) { //
								row_tLogRow_2[13] = String.valueOf(Les_donnees_a_regetees.Model);

							} //

							if (Les_donnees_a_regetees.Kilometres != null) { //
								row_tLogRow_2[14] = String.valueOf(Les_donnees_a_regetees.Kilometres);

							} //

							if (Les_donnees_a_regetees.Body_Type != null) { //
								row_tLogRow_2[15] = String.valueOf(Les_donnees_a_regetees.Body_Type);

							} //

							if (Les_donnees_a_regetees.Engine != null) { //
								row_tLogRow_2[16] = String.valueOf(Les_donnees_a_regetees.Engine);

							} //

							if (Les_donnees_a_regetees._Transmission != null) { //
								row_tLogRow_2[17] = String.valueOf(Les_donnees_a_regetees._Transmission);

							} //

							if (Les_donnees_a_regetees.Drivetrain != null) { //
								row_tLogRow_2[18] = String.valueOf(Les_donnees_a_regetees.Drivetrain);

							} //

							if (Les_donnees_a_regetees._Exterior_Colour != null) { //
								row_tLogRow_2[19] = String.valueOf(Les_donnees_a_regetees._Exterior_Colour);

							} //

							if (Les_donnees_a_regetees._Interior_Colour != null) { //
								row_tLogRow_2[20] = String.valueOf(Les_donnees_a_regetees._Interior_Colour);

							} //

							if (Les_donnees_a_regetees._Passengers != null) { //
								row_tLogRow_2[21] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees._Passengers);

							} //

							if (Les_donnees_a_regetees.Doors != null) { //
								row_tLogRow_2[22] = String.valueOf(Les_donnees_a_regetees.Doors);

							} //

							if (Les_donnees_a_regetees._Fuel_Type != null) { //
								row_tLogRow_2[23] = String.valueOf(Les_donnees_a_regetees._Fuel_Type);

							} //

							if (Les_donnees_a_regetees.City != null) { //
								row_tLogRow_2[24] = String.valueOf(Les_donnees_a_regetees.City);

							} //

							if (Les_donnees_a_regetees._Highway != null) { //
								row_tLogRow_2[25] = String.valueOf(Les_donnees_a_regetees._Highway);

							} //

							if (Les_donnees_a_regetees.price != null) { //
								row_tLogRow_2[26] = FormatterUtils.formatUnwithE(Les_donnees_a_regetees.price);

							} //

							if (Les_donnees_a_regetees.generator != null) { //
								row_tLogRow_2[27] = FormatterUtils.format_Date(Les_donnees_a_regetees.generator,
										"dd-MM-yyyy");
...
///////////////////////    			
						...
						} // End of branch "Les_donnees_a_regetees"
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Les_donnees_a_regetees");
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(out1,Les_donnees_a_regetees)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:KvIh8oVQgFESUKVOAeElUnsZ/cJnX3Uy50AUqYh1d+RyefFrTc5Slw==");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tMap.class.getClassLoader()
					.getResourceAsStream("test_etl/tmap_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 162733 characters generated by Talend Open Studio for Data Integration on the
 * 27 septembre 2023 à 19:07:35 GMT+01:00
 ************************************************************************************************/