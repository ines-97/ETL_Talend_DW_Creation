...
package test_etl.send_mail_0_1;
 ...
 * @status
 */
public class Send_Mail implements TalendJob {
	...
	private final String jobName = "Send_Mail";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Send_Mail.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSendMail_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String from_tSendMail_2 = ("inessadki1254@gmail.com");
				String to_tSendMail_2 = ("ines.sadki1@outlook.com").replace(";", ",");
				String cc_tSendMail_2 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String bcc_tSendMail_2 = (("") == null || "".equals("")) ? null : ("").replace(";", ",");
				String subject_tSendMail_2 = ("Test des emails avec Talend");
				...
				String message_tSendMail_2 = (("Hello talend") == null || "".equals("Hello talend")) ? "\"\""
						: ("Hello talend");
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_2 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:VdBoPWc1WPWwxKzkLr8xdjOCueddmV1IciPm9ElxbcZyJjZWfg==");

									return new javax.mail.PasswordAuthentication("inessadki1254@gmail.com",
											decryptedPassword_tSendMail_2);
								}
							});

					javax.mail.Message msg_tSendMail_2 = new javax.mail.internet.MimeMessage(session_tSendMail_2);
					msg_tSendMail_2.setFrom(new javax.mail.internet.InternetAddress(from_tSendMail_2, "Talend"));
	...
	public static void main(String[] args) {
		final Send_Mail Send_MailClass = new Send_Mail();

		int exitCode = Send_MailClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Send_Mail.class.getClassLoader()
					.getResourceAsStream("test_etl/send_mail_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Send_Mail.class.getClassLoader()
		...
		} catch (TalendException e_tSendMail_2) {
			globalMap.put("tSendMail_2_SUBPROCESS_STATE", -1);

			e_tSendMail_2.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Send_Mail");
		}
...
/************************************************************************************************
 * 31175 characters generated by Talend Open Studio for Data Integration on the
 * 27 septembre 2023 à 18:25:06 GMT+01:00
 ************************************************************************************************/