...
package test_etl.taggrigaterow_0_1;
...
/**
 * Job: tAggrigateRow Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class tAggrigateRow implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "tAggrigateRow";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				tAggrigateRow.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(tAggrigateRow.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:USx/TYhanfynRj5vjjw1NZuqmSOZEvC8901P45P4fCkD8CKNMG+Fnw==");
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TEST_ETL_tAggrigateRow = new byte[0];
    static byte[] commonByteArray_TEST_ETL_tAggrigateRow = new byte[0];
			    ...
			    public Float Total_enfants;

				public Float getTotal_enfants () {
					return this.Total_enfants;
				}
				
			    public Float prix_moyenne;

				public Float getPrix_moyenne () {
					return this.prix_moyenne;
				}
				
			    public Float age_moyen;

				public Float getAge_moyen () {
					return this.age_moyen;
				}
				
			    public Float Somme_prix;

				public Float getSomme_prix () {
					return this.Somme_prix;
				}
				
			    public Float moyenne_charge;

				public Float getMoyenne_charge () {
					return this.moyenne_charge;
				}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_ETL_tAggrigateRow) {
        	...
        	try {
        		...
        		int length = 0;
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Total_enfants = null;
           				} else {
           			    	this.Total_enfants = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.prix_moyenne = null;
           				} else {
           			    	this.prix_moyenne = dis.readFloat();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.age_moyen = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Somme_prix = null;
           				} else {
           			    	this.Somme_prix = dis.readFloat();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.moyenne_charge = null;
           				} else {
           			    	this.moyenne_charge = dis.readFloat();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Float
						...
						if(this.Total_enfants == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.Total_enfants);
		            	}
					
					// Float
				
						if(this.prix_moyenne == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.prix_moyenne);
		            	}
					
					// Float
				
						if(this.age_moyen == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.age_moyen);
		            	}
					
					// Float
				
						if(this.Somme_prix == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.Somme_prix);
		            	}
					
					// Float
				
						if(this.moyenne_charge == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeFloat(this.moyenne_charge);
		            	}
    ...
    public String toString() {
		...
		sb.append(",Total_enfants="+String.valueOf(Total_enfants));
		sb.append(",prix_moyenne="+String.valueOf(prix_moyenne));
		sb.append(",age_moyen="+String.valueOf(age_moyen));
		sb.append(",Somme_prix="+String.valueOf(Somme_prix));
		sb.append(",moyenne_charge="+String.valueOf(moyenne_charge));
	    sb.append("]");
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_ETL_tAggrigateRow.length) {
				if(length < 1024 && commonByteArray_TEST_ETL_tAggrigateRow.length == 0) {
   					commonByteArray_TEST_ETL_tAggrigateRow = new byte[1024];
				} else {
   					commonByteArray_TEST_ETL_tAggrigateRow = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_ETL_tAggrigateRow, 0, length);
			strReturn = new String(commonByteArray_TEST_ETL_tAggrigateRow, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				Float age;BigDecimal Total_enfants_sum;
           			BigDecimal prix_moyenne_sum;
           			int prix_moyenne_count = 0;
           			BigDecimal age_moyen_sum;
           			int age_moyen_count = 0;
           			BigDecimal Somme_prix_sum;
           			BigDecimal moyenne_charge_sum;
           			int moyenne_charge_count = 0;
...
operation_finder_tAggregateRow_1.age = out1.age;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
				...
				if(out1.children != null) { // G_OutMain_AggR_546
				
					if(operation_result_tAggregateRow_1.Total_enfants_sum == null) {
						operation_result_tAggregateRow_1.Total_enfants_sum = new BigDecimal(0);
					}
					operation_result_tAggregateRow_1.Total_enfants_sum = operation_result_tAggregateRow_1.Total_enfants_sum.add(
						new BigDecimal(
							String.valueOf(
								out1.children
							)
				...
				if(out1.price != null) { // G_OutMain_AggR_546
				
				operation_result_tAggregateRow_1.prix_moyenne_count++;
				
					if(operation_result_tAggregateRow_1.prix_moyenne_sum == null) {
						operation_result_tAggregateRow_1.prix_moyenne_sum = new BigDecimal(0);
					}
					operation_result_tAggregateRow_1.prix_moyenne_sum = operation_result_tAggregateRow_1.prix_moyenne_sum.add(
						new BigDecimal(
							String.valueOf(
								out1.price
							)
				...
				if(out1.age != null) { // G_OutMain_AggR_546
				
				operation_result_tAggregateRow_1.age_moyen_count++;
				
					if(operation_result_tAggregateRow_1.age_moyen_sum == null) {
						operation_result_tAggregateRow_1.age_moyen_sum = new BigDecimal(0);
					}
					operation_result_tAggregateRow_1.age_moyen_sum = operation_result_tAggregateRow_1.age_moyen_sum.add(
						new BigDecimal(
							String.valueOf(
								out1.age
							)
				...
				if(out1.price != null) { // G_OutMain_AggR_546
					...
					if(operation_result_tAggregateRow_1.Somme_prix_sum == null) {
						operation_result_tAggregateRow_1.Somme_prix_sum = new BigDecimal(0);
					}
					operation_result_tAggregateRow_1.Somme_prix_sum = operation_result_tAggregateRow_1.Somme_prix_sum.add(
						new BigDecimal(
							String.valueOf(
								out1.price
							)
				...
				if(out1.charges != null) { // G_OutMain_AggR_546
				
				operation_result_tAggregateRow_1.moyenne_charge_count++;
				
					if(operation_result_tAggregateRow_1.moyenne_charge_sum == null) {
						operation_result_tAggregateRow_1.moyenne_charge_sum = new BigDecimal(0);
					}
					operation_result_tAggregateRow_1.moyenne_charge_sum = operation_result_tAggregateRow_1.moyenne_charge_sum.add(
						new BigDecimal(
							String.valueOf(
								out1.charges
							)
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"age","Total_enfants","prix_moyenne","age_moyen","Somme_prix","moyenne_charge",});        
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row3.age = aggregated_row_tAggregateRow_1.age;
    								...
    								if(aggregated_row_tAggregateRow_1.Total_enfants_sum != null) {
    								row3.Total_enfants = aggregated_row_tAggregateRow_1.Total_enfants_sum.floatValue();
										
    								}else{
    								
    									row3.Total_enfants = null;
    									
    								}
    								
                                if(aggregated_row_tAggregateRow_1.prix_moyenne_count > 0){
                                	
	    								row3.prix_moyenne = aggregated_row_tAggregateRow_1.prix_moyenne_sum.divide(new BigDecimal(String.valueOf(aggregated_row_tAggregateRow_1.prix_moyenne_count)), 10, BigDecimal.ROUND_HALF_UP)
                                		...
                                		String count = "0";
    		    							...
    		    							row3.prix_moyenne = ParserUtils.parseTo_Float(count);
    									
                                }
                                if(aggregated_row_tAggregateRow_1.age_moyen_count > 0){
                                	
	    								row3.age_moyen = aggregated_row_tAggregateRow_1.age_moyen_sum.divide(new BigDecimal(String.valueOf(aggregated_row_tAggregateRow_1.age_moyen_count)), 10, BigDecimal.ROUND_HALF_UP)
                                		...
                                		String count = "0";
    		    							...
    		    							row3.age_moyen = ParserUtils.parseTo_Float(count);
    									
                                }
    								if(aggregated_row_tAggregateRow_1.Somme_prix_sum != null) {
    								row3.Somme_prix = aggregated_row_tAggregateRow_1.Somme_prix_sum.floatValue();
										
    								}else{
    								
    									row3.Somme_prix = null;
    									
    								}
    								
                                if(aggregated_row_tAggregateRow_1.moyenne_charge_count > 0){
                                	
	    								row3.moyenne_charge = aggregated_row_tAggregateRow_1.moyenne_charge_sum.divide(new BigDecimal(String.valueOf(aggregated_row_tAggregateRow_1.moyenne_charge_count)), 10, BigDecimal.ROUND_HALF_UP)
                                		...
                                		String count = "0";
    		    							...
    		    							row3.moyenne_charge = ParserUtils.parseTo_Float(count);
...
///////////////////////		
	    		...
	    		if(row3.Total_enfants != null) { //              
                 row_tLogRow_1[1]=    						
								FormatterUtils.formatUnwithE(row3.Total_enfants)
					          ;	
							
	    		} //			
    			   				
	    		if(row3.prix_moyenne != null) { //              
                 row_tLogRow_1[2]=    						
								FormatterUtils.formatUnwithE(row3.prix_moyenne)
					          ;	
							
	    		} //			
    			   				
	    		if(row3.age_moyen != null) { //              
                 row_tLogRow_1[3]=    						
								FormatterUtils.formatUnwithE(row3.age_moyen)
					          ;	
							
	    		} //			
    			   				
	    		if(row3.Somme_prix != null) { //              
                 row_tLogRow_1[4]=    						
								FormatterUtils.formatUnwithE(row3.Somme_prix)
					          ;	
							
	    		} //			
    			   				
	    		if(row3.moyenne_charge != null) { //              
                 row_tLogRow_1[5]=    						
								FormatterUtils.formatUnwithE(row3.moyenne_charge)
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final tAggrigateRow tAggrigateRowClass = new tAggrigateRow();

        int exitCode = tAggrigateRowClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = tAggrigateRow.class.getClassLoader().getResourceAsStream("test_etl/taggrigaterow_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = tAggrigateRow.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tAggrigateRow");
        }
...
/************************************************************************************************
 *     140337 characters generated by Talend Open Studio for Data Integration 
