...
package test_etl.creation_ods_0_1;
...
/**
 * Job: Creation_ODS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Creation_ODS implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Creation_ODS";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Creation_ODS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UQ2sM0DpJURWN2WtjvEeAPdihDAPtWpaTAfnuTX1wr0weqOF7+c1LA==");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		test_etl.generer_calendrier2_0_2.Generer_calendrier2 childJob_tRunJob_1 = new test_etl.generer_calendrier2_0_2.Generer_calendrier2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		test_etl.taggrigaterow_0_1.tAggrigateRow childJob_tRunJob_2 = new test_etl.taggrigaterow_0_1.tAggrigateRow();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		test_etl.tfilterrow_0_1.tFilterRow childJob_tRunJob_3 = new test_etl.tfilterrow_0_1.tFilterRow();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		test_etl.tuniqrow_0_1.tUniqRow childJob_tRunJob_4 = new test_etl.tuniqrow_0_1.tUniqRow();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		test_etl.tsortrow_0_1.tSortRow childJob_tRunJob_5 = new test_etl.tsortrow_0_1.tSortRow();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Creation_ODS Creation_ODSClass = new Creation_ODS();

        int exitCode = Creation_ODSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Creation_ODS.class.getClassLoader().getResourceAsStream("test_etl/creation_ods_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Creation_ODS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Creation_ODS");
        }
...
/************************************************************************************************
 *     81694 characters generated by Talend Open Studio for Data Integration 
