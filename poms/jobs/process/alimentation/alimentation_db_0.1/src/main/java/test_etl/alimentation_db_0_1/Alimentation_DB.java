...
package test_etl.alimentation_db_0_1;
...
/**
 * Job: Alimentation_DB Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Alimentation_DB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Alimentation_DB";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Alimentation_DB.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Alimentation_DB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		test_etl.creation_ods_0_1.Creation_ODS childJob_tRunJob_2 = new test_etl.creation_ods_0_1.Creation_ODS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		test_etl.alimenter_dwh_0_1.alimenter_DWH childJob_tRunJob_1 = new test_etl.alimenter_dwh_0_1.alimenter_DWH();
	    // pass DataSources
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0PFuoGC+07XJyPhdWg+3EgmPsHbgHylwylDAJDwrK5ofqVeEmb6fXA==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3wXw8vMkQtregiPq/MosR2/OZuV+8Ny69KN7twRGFW5L+kSprdv4AA==");
 ...
 */
    ...
    public static void main(String[] args){
        final Alimentation_DB Alimentation_DBClass = new Alimentation_DB();

        int exitCode = Alimentation_DBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Alimentation_DB.class.getClassLoader().getResourceAsStream("test_etl/alimentation_db_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Alimentation_DB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Alimentation_DB");
        }
...
/************************************************************************************************
 *     67119 characters generated by Talend Open Studio for Data Integration 
