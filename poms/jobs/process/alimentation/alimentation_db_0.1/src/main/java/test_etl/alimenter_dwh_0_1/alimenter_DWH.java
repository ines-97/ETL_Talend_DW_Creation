...
package test_etl.alimenter_dwh_0_1;
...
/**
 * Job: alimenter_DWH Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class alimenter_DWH implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "alimenter_DWH";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				alimenter_DWH.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(alimenter_DWH.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		test_etl.taggrigaterow_0_1.tAggrigateRow childJob_tRunJob_1 = new test_etl.taggrigaterow_0_1.tAggrigateRow();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		test_etl.tfilterrow_0_1.tFilterRow childJob_tRunJob_2 = new test_etl.tfilterrow_0_1.tFilterRow();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		test_etl.tjoin_0_1.tJoin childJob_tRunJob_3 = new test_etl.tjoin_0_1.tJoin();
	    // pass DataSources
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Dnk0mgKoNWe7wILkRnLb9y/J9APQfNphOOISa+yNB0+GN21es7dOzA==");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
		...
		int tos_count_tDBConnection_2 = 0;
            ...
            String url_tDBConnection_2 = "jdbc:postgresql://"+"localhost"+":"+"5432"+"/"+"Data1_GoogleStore";
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Fp9f19ryJsjF6JK32yA/zSruSyp2nvBEcA0w6Mk9Am98BcfI4RbMAw==");
 ...
 */
    ...
    public static void main(String[] args){
        final alimenter_DWH alimenter_DWHClass = new alimenter_DWH();

        int exitCode = alimenter_DWHClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = alimenter_DWH.class.getClassLoader().getResourceAsStream("test_etl/alimenter_dwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = alimenter_DWH.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : alimenter_DWH");
        }
...
/************************************************************************************************
 *     74767 characters generated by Talend Open Studio for Data Integration 
